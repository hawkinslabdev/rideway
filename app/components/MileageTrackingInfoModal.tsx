...
export default function MileageTrackingInfoModal({ onClose }: MileageTrackingInfoModalProps) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
      <div className="bg-white rounded-lg w-full max-w-xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="p-4 border-t bg-gray-50 flex justify-end">
          <button
            onClick={onClose}
            className="px-4 py-3 sm:py-2 inline-flex items-center bg-blue-600 text-white rounded-md hover:bg-blue-700"
          >
